...
+ Unternehmen{#companies}
   ...
   + [Gerätediagramm-Optionen für Unternehmen](companies/admin-device-graph-options.md)
   + [ID-Synchronisierung mit Media Optimizer](companies/admin-amo-sync.md)
   + [Verwalten von First-Party-Datenanbietern](companies/admin-first-party-providers.md)
   + [Verwalten von Drittanbietern von Daten](companies/admin-third-party-providers.md)
   + [Verwalten von Unternehmenszielen](companies/admin-manage-company-destinations.md)
   + [Verwalten von Unternehmensbeschränkungen](companies/admin-company-limits.md)
