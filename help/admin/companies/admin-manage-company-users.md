...
1. Um einen neuen Benutzer zu erstellen, klicken Sie auf **[!UICONTROL Create a New User]**. Um einen vorhandenen Benutzer zu bearbeiten, suchen Sie den gewünschten Benutzer und klicken Sie auf die Spalte **[!UICONTROL Username]** .
...
1. Füllen Sie die Felder aus:
   ...
   * **[!UICONTROL IMS ID]**: Der [!UICONTROL Identity Management System ID] des Benutzers. Mit dieser ID kann der Benutzer Adobe-Lösungen mit der Adobe Experience Cloud verknüpfen.
