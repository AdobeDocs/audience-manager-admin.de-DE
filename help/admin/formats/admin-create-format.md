...
1. (Bedingt) Wenn Sie **[!UICONTROL File]** auswählen, füllen Sie die Felder aus:
   ...
   * **[!UICONTROL MD5 Checksum Receipt]:** Gibt an, dass ein [!DNL MD5] Prüfsummenbeleg generiert wird. Der Prüfsummenbeleg [!DNL MD5] , damit Partner überprüfen können, ob der Audience Manager die gesamte Übertragung ordnungsgemäß durchgeführt hat.

1. (Bedingt) Wenn Sie **[!UICONTROL HTTP]** auswählen, füllen Sie die Felder aus:

   * **[!UICONTROL Method]:** Wählen Sie die [!DNL API]-Methode, die Sie für Ihren Übertragungsprozess verwenden möchten:
      * **[!UICONTROL POST]:** Wenn Sie [!DNL POST] auswählen, wählen Sie den Inhaltstyp ([!DNL XML] oder [!DNL JSON]) und geben Sie dann den Anfrageinhalt an.
