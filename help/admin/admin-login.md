...
title: Bei Audience Manager Admin anmelden
...
# Bei Audience Manager Admin anmelden {#log-in-to-audience-manager-admin}
...
1. Greifen Sie auf das Audience Manager-[!DNL Admin]-Tool zu, indem Sie zu den folgenden [!DNL URL] navigieren: [https://admin.demdex.com/](https://admin.demdex.com/).
1. Wählen Sie Ihre bevorzugte Überprüfungsmethode im Dropdown-Feld aus und klicken Sie auf **[!UICONTROL Verify]**.
